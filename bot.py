...
# === ТЕМЫ ВОПРОСОВ ===
QUESTION_GROUPS = {
    'detector': '🕵️ Детектор лжи',
    'dark': '😈 Тёмная сторона',
    'dino': '🤪 Я — динозавр?',
    'frog': '🐸 Лягушка или принцесса?',
    'crush': '💘 Кто твой краш?',
    'sisters': '👯 Сёстры или соперницы?',
...
QUESTIONS = {
    'detector': [
        "🕵️ Что я скажу если ты спросишь «я тебе нравлюсь?»",
        "🤥 На сколько я оцениваю твои шутки от 1 до 10?",
        "🙈 Что я говорю когда ты спрашиваешь «я красивая?»",
        "😤 Что я делаю когда ты говоришь «обиделась» а я реально обиделась?",
        "💕 Что я отвечу на «ты меня любишь?» в 3 часа ночи?",
        "📱 Что я скажу если ты прочитаешь мою переписку с крашем?",
        "🍕 Что я ем когда говорю «я на диете»?",
        "⏰ На сколько я реально опаздываю когда говорю «я уже выхожу»?",
        "💰 Сколько я потратила на самом деле когда сказала «недорого»?",
        "📚 Что я сказала маме про оценки на самом деле?",
        "😤 Что я думаю о твоём парне на самом деле?",
        "🌙 Что я делаю ночью вместо сна?",
        "👗 Что я скажу если ты спросишь «я толстая?»",
        "🤐 Кому я рассказала твой секрет?",
        "📝 Что я отвечу на «дай списать»?",
        "😂 Что я думаю о твоих шутках на самом деле?",
        "🎂 Что я скажу если забуду про твой ДР?",
        "👻 Что я делаю когда вижу твоё сообщение и не отвечаю?",
        "💄 Что я скажу если ты возьмёшь мою помаду без спроса?",
        "😴 Что я делаю когда говорю «я занята»?",
    ],
    'dark': [
        "😈 Что я делаю с твоими фото которые мне не нравятся?",
        "💅 О чём я думаю когда ты говоришь 30 минут подряд?",
        "🔍 Что я скрываю в своём телефоне?",
        "😢 Что я на самом деле думаю о твоих советах?",
        "🙊 Что я делаю когда никто не видит?",
        "💸 На что я трачу все карманные деньги?",
        "🎁 Кому я передариваю подарки?",
        "👀 За кем я слежу в соцсетях тайно?",
        "😤 Что меня реально бесит в тебе?",
        "🫥 Что бы я сделала если бы стала невидимкой на 1 час?",
        "🕯️ Какое желание я загадала бы джинну?",
        "👻 Чего я боюсь но никогда не признаюсь?",
        "🔮 Кому я завидую в глубине души?",
        "📖 Что я пишу в своём личном дневнике?",
        "🗣️ О ком я сплетничаю за спиной?",
        "🎭 Кем я притворяюсь на публике?",
        "💔 Что я никогда тебе не прощу?",
        "🤳 Какое фото я удалила через 5 минут после публикации?",
        "📵 Кого я игнорирую специально?",
        "🖤 О чём я вру сама себе?",
    ],
    'dino': [
        "🤪 Как я ем пиццу когда никто не видит?",
        "🏃‍♀️ Что я делаю когда опаздываю в школу?",
        "💃 Как я танцую когда думаю что никто не смотрит?",
        "🍪 Где моя заначка вкусняшек от мамы?",
        "😴 Как я выгляжу когда просыпаюсь?",
        "🎤 Что я пою в душе?",
        "🎨 Моё самое странное хобби?",
        "😂 Как я смеюсь когда реально смешно?",
        "🧦 Парные ли у меня носки сегодня?",
        "🛌 В какой позе я сплю?",
        "🦷 Чищу ли я зубы перед сном?",
        "📺 Что я смотрю когда говорю «учу уроки»?",
        "🐒 Какое моё самое дикое действие за последний месяц?",
        "🍔 Что я заказываю втайне от всех?",
        "🚿 Сколько минут я пою в душе?",
        "🪞 Сколько раз в день я смотрю в зеркало?",
        "📱 Что я лайкаю в 3 часа ночи?",
        "🎮 В какую игру я играю тайком от всех?",
        "🍫 Где моя заначка сладкого от мамы?",
        "🤳 Сколько селфи я делаю перед тем как выложить одно?",
    ],
    'frog': [
        "🐸 Кто я: лягушка или принцесса?",
        "👑 Что меня превращает в принцессу?",
        "🍝 Моё королевское блюдо?",
        "🏰 Где мой замок?",
        "🤴 Кто мой принц на самом деле?",
        "😤 Что меня бесит по-королевски?",
        "🌟 Какое желание я загадаю золотой рыбке?",
        "💎 Какой мой скрытый талант?",
        "💖 Что я делаю для подруг?",
        "🦸 Моя суперсила?",
        "🌹 Люблю ли я комплименты?",
        "🎀 Какой мой стиль?",
        "💄 Сколько у меня косметики?",
        "👠 Каблуки или кеды?",
        "📸 Люблю ли я фоткаться?",
        "🎵 Под какую музыку я просыпаюсь?",
        "🌈 Какой мой любимый цвет?",
        "🌸 Что делает меня счастливой?",
        "🦋 Что я делаю чтобы быть красивой?",
        "💕 Что для меня идеальный день?",
    ],
    'crush': [
        "💘 Кто мой краш сейчас?",
        "😍 Какой типаж парней мне нравится?",
        "💬 Кто мне написал первый?",
        "💋 Был ли у меня первый поцелуй?",
        "🌹 Куда я хочу на первое свидание?",
        "😤 Ревнивая ли я по шкале от 1 до 10?",
        "💃 Что я делаю чтобы привлечь внимание?",
        "👻 Кто мой бывший?",
        "💍 Хочу ли я замуж до 25?",
        "💖 Что для меня идеальные отношения?",
        "📱 Кто у меня в избранном в телефоне?",
        "💌 Кому я писала любовные признания?",
        "🎵 Какая песня про мою любовь?",
        "👀 На кого я западаю из класса?",
        "💭 О ком я думаю перед сном?",
        "🎬 Кто мой идеальный парень из фильма?",
        "💔 Как я переживаю расставания?",
        "💕 Внешность или характер?",
        "😳 Как я показываю что влюбилась?",
        "💝 Что я хочу на 14 февраля?",
    ],
    'sisters': [
        "👯 Кто из нас главная в нашей паре?",
        "👀 Завидую ли я тебе?",
        "😤 Что меня реально бесит в тебе?",
        "💕 За что я тебя люблю?",
        "😢 Из-за чего мы ссорились?",
        "🤝 Кто первый мирится?",
        "💪 Что я готова для тебя сделать?",
        "👸 Кто из нас красивее?",
        "🧠 Кто умнее?",
        "😂 Кто смешнее?",
        "👗 Кто стильнее одевается?",
        "💄 Кто красится лучше?",
        "📱 У кого больше подписчиков?",
        "🎤 Кто лучше поёт в караоке?",
        "💃 Кто лучше танцует?",
        "🍳 Кто вкуснее готовит?",
        "💪 Кто сильнее физически?",
        "🏆 Кто успешнее в жизни?",
        "💎 Кто больше нравится парням?",
        "💖 Кто лучшая подруга в мире?",
    ],
    'truth_or_dare': [
        "🃏 Правда или действие — что я выберу?",
        "😳 Мой самый стыдный момент в школе?",
        "🚫 Что я никогда не сделаю даже за миллион?",
        "🎲 На что я готова на спор?",
        "🌟 Какой у меня скрытый талант?",
        "🆕 Что я хочу попробовать впервые?",
        "✈️ Куда бы я улетела прямо сейчас?",
        "🔄 С кем бы я поменялась жизнью на день?",
        "🗣️ Что я скажу если встречу кумира?",
        "💸 На что я потрачу миллион?",
        "🎤 Какую песню я спою на публике?",
        "💃 Какой танец я станцую на вечеринке?",
        "📸 Какое фото я никогда не выложу?",
        "💬 Что я напишу крашу первой?",
        "🎁 Что я подарю лучшей подруге?",
        "🍕 Какую пиццу я закажу на всех?",
        "🎬 Какой фильм я пересмотрю 100 раз?",
        "📚 Какую книгу я всем советую?",
        "🎵 Какая песня сейчас играет у меня в голове?",
        "🌈 Что я сделаю чтобы мир стал лучше?",
    ],
    'bomb': [
        "💣 Что я сделаю если узнаю что парень мне изменяет?",
        "😱 Что я кричу когда вижу паука?",
        "🏃‍♀️ Что я делаю когда опаздываю на 10 минут?",
        "🍕 Что я закажу если у меня последние 500₽?",
        "⚡ Что я делаю быстрее чем одеваюсь?",
        "👀 Что я отвечу если краш спросит «ты мне нравишься?»",
        "🗣️ Что я скажу если меня вызовут к доске а я не готова?",
        "📝 Что я напишу в соцсетях если поругаюсь с подругой?",
        "🔄 Что я делаю когда никто не пишет?",
        "🤖 Что я делаю на автомате когда задумалась?",
        "🎯 Что я угадаю о человеке с первого взгляда?",
        "⏱️ За сколько я соберусь если проспала?",
        "🚀 Что я сделаю за 60 секунд в ТикТоке?",
        "🎲 Что я выберу: правду или действие?",
        "📞 Кому я позвоню в 3 часа ночи в истерике?",
        "💡 Что я придумаю чтобы не идти в школу?",
        "🔥 Что я зажгу на вечеринке если все скучают?",
        "😂 Что я скажу чтобы разрядить неловкую паузу?",
        "🎵 Какую песню я включу чтобы поднять настроение?",
        "📱 Что я сделаю если упадёт телефон в унитаз?",
    ],
    'night': [
        "🌙 О чём я думаю в 3 часа ночи?",
        "💭 Что мне снилось сегодня?",
        "👻 Боюсь ли я темноты?",
        "👯 С кем бы я погуляла ночью по городу?",
        "🎨 Чем я занимаюсь когда не спится?",
        "🍪 Что я ем тайком ночью?",
        "🎬 Смотрю ли я ужастики перед сном?",
        "😴 Как я засыпаю?",
        "📱 Что я делаю в телефоне ночью?",
        "💌 Какое сообщение я написала и не отправила?",
        "🌟 Что я загадала на падающую звезду?",
        "🌌 О чём я мечтаю глядя на звёзды?",
        "🎧 Что я слушаю в наушниках перед сном?",
        "📖 Читаю ли я перед сном?",
        "🕯️ Боюсь ли я спать одна в комнате?",
        "🧸 С какой игрушкой я сплю?",
        "💤 Сколько часов мне нужно чтобы выспаться?",
        "🌅 Встречала ли я рассвет?",
        "🎶 Под какую колыбельную я засыпаю?",
        "💭 Что я бормочу во сне?",
    ],
    'morning': [
        "☕ Как я просыпаюсь по утрам?",
        "🙈 Без чего я не могу выйти из дома?",
        "🍳 Что я ем на завтрак?",
        "⏰ Сколько раз я перевожу будильник?",
        "😊 Какое у меня настроение утром?",
        "📱 Что я проверяю в телефоне первым делом?",
        "💬 Кому я пишу «доброе утро»?",
        "🪞 Как я выгляжу сразу после пробуждения?",
        "🏃‍♀️ Опаздываю ли я в школу?",
        "🧘‍♀️ Какой у меня утренний ритуал?",
        "🎵 Что я слушаю пока собираюсь?",
        "🚿 Сколько минут я провожу в душе?",
        "💄 Крашусь ли я каждый день?",
        "👗 Сколько нарядов я меняю перед выходом?",
        "☀️ Люблю ли я утро или я сова?",
        "😤 Что меня бесит по утрам?",
        "🍵 Чай или кофе?",
        "📺 Смотрю ли я что-то пока завтракаю?",
        "💪 Делаю ли я зарядку?",
        "🌸 Что делает моё утро идеальным?",
    ],
    'birthday': [
        "🎂 Что я хочу на день рождения?",
        "🎉 Как я люблю праздновать?",
        "👯 Кого я приглашу в первую очередь?",
        "🍰 Какой торт я закажу?",
        "🎁 Какой лучший подарок я получала?",
        "🌟 Что я загадаю задувая свечи?",
        "🎈 Какой мой идеальный день рождения?",
        "💬 Кто поздравит меня первым?",
        "🎵 Какую песню мне споют?",
        "🕯️ Сколько мне исполнится?",
        "🎊 Какую вечеринку я хочу?",
        "💐 Какие цветы я люблю?",
        "📸 Сколько фото я сделаю в свой ДР?",
        "💃 Буду ли я танцевать до упаду?",
        "🎤 Буду ли я петь в караоке?",
        "🍕 Какая еда будет на столе?",
        "👗 Что я надену?",
        "💄 Какой макияж я сделаю?",
        "🎁 Без какого подарка праздник не праздник?",
        "💕 Кто самый важный гость на моём ДР?",
    ],
    'newyear': [
        "🎄 Что я загадаю на Новый год?",
        "📍 Где я встречу Новый год?",
        "💕 С кем я хочу быть в полночь?",
        "🍊 Какое моё любимое новогоднее блюдо?",
        "👗 Что я надену на Новый год?",
        "🎬 Какой фильм я смотрю каждый НГ?",
        "✨ Что я обещаю себе в новом году?",
        "🌟 Верю ли я в новогоднее чудо?",
        "🎁 Кому я подарю самый дорогой подарок?",
        "🏠 Как я украшаю дом к празднику?",
        "🎅 Верю ли я в Деда Мороза?",
        "🛷 Катаюсь ли я на санках или ватрушках?",
        "⛄ Люблю ли я зиму?",
        "🎆 Запускаю ли я фейерверки?",
        "🍾 Что я пью в новогоднюю ночь?",
        "📸 Сколько фото я сделаю за ночь?",
        "💃 Буду ли я танцевать до утра?",
        "🎵 Под какую песню я встречаю НГ?",
        "💌 Кому я напишу первой в новом году?",
        "💎 Что я хочу изменить в новом году?",
    ],
}
...
def get_friendship_prediction(score, name):
    if score >= 90:
        ...
        predictions = [
            f"🌸 Ты знаешь {name} неплохо, но есть куда расти! Проводите больше времени вместе, это сближает 💫",
            f"🌱 Ваша дружба с {name} только расцветает! Делитесь секретами, мечтами и любимыми треками 🎧",
            f"💫 Ты уже многое знаешь о {name}! Ещё немного — и вы станете ближе! Устройте совместную прогулку 🌈",
...
def can_create_test(user_id):
    return True  # Freemium — безлимитно для всех
...
def get_main_keyboard(user_id=None):
    ...
    keyboard = [
        ...
        [KeyboardButton("👑 Мои тесты"), KeyboardButton("🏆 Топ подруг")],
        [KeyboardButton("⭐ Зодиак"), KeyboardButton("🎁 Бонус дня")],
    ]
    if user_id == ADMIN_ID:
...
def get_admin_keyboard():
    return ReplyKeyboardMarkup([
        ...
        [KeyboardButton("🛡 Антиспам"), KeyboardButton("📢 Рассылка")],
...
def get_question_groups_keyboard():
    ...
    # Хиты
    kb.append([InlineKeyboardButton("🕵️ Детектор лжи 🔥", callback_data="group_detector"),
               InlineKeyboardButton("😈 Тёмная сторона 🔥", callback_data="group_dark")])
    kb.append([InlineKeyboardButton("🤪 Я — динозавр? 😂", callback_data="group_dino"),
               InlineKeyboardButton("🐸 Лягушка или принцесса? 😂", callback_data="group_frog")])
    kb.append([InlineKeyboardButton("💘 Кто твой краш? 💕", callback_data="group_crush"),
               InlineKeyboardButton("👯 Сёстры или соперницы? 💕", callback_data="group_sisters")])
    kb.append([InlineKeyboardButton("🃏 Правда или действие 🎮", callback_data="group_truth_or_dare"),
               InlineKeyboardButton("💣 Бомба 🎮", callback_data="group_bomb")])
    kb.append([InlineKeyboardButton("🌙 Ночная версия 🌈", callback_data="group_night"),
               InlineKeyboardButton("☕ Утренний вайб 🌈", callback_data="group_morning")])
    kb.append([InlineKeyboardButton("🎂 День рождения 🎪", callback_data="group_birthday"),
               InlineKeyboardButton("🎄 Новый год 🎪", callback_data="group_newyear")])
    kb.append([InlineKeyboardButton("🎲 Случайный тест-пак", callback_data="group_random")])
    kb.append([InlineKeyboardButton("✏️ Создать свой тест", callback_data="custom_test")])
...
def get_test_actions_keyboard(test_id, user_id=None):
    if user_id and is_premium(user_id):
        ...
        return InlineKeyboardMarkup([
            [InlineKeyboardButton("👁 Посмотреть", callback_data=f"view_{test_id}"),
             InlineKeyboardButton("📤 Поделиться", callback_data=f"share_{test_id}")],
            [InlineKeyboardButton("🔒 Ответы подруг — VIP", callback_data=f"go_premium")],
            [InlineKeyboardButton("🗑 Удалить тест", callback_data=f"delete_{test_id}")]
        ])
...
def get_premium_keyboard():
    return InlineKeyboardMarkup([
        [InlineKeyboardButton("👁 1 ответ — 29₽", callback_data="buy_1view")],
        [InlineKeyboardButton("👁 3 ответа — 59₽", callback_data="buy_3views")],
        [InlineKeyboardButton("👁 10 ответов — 129₽", callback_data="buy_10views")],
        [InlineKeyboardButton("🌸 1 день — 49₽", callback_data="buy_1day")],
        [InlineKeyboardButton("⭐ 7 дней — 99₽", callback_data="buy_7days")],
        [InlineKeyboardButton("💎 Навсегда — 399₽", callback_data="buy_forever")]
    ])
# === ОСНОВНЫЕ ХЕНДЛЕРЫ ===
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"ПРОВЕРКА pending: user_data={dict(user_data)}, pending={pending}")
    if pending:
        test = get_test_by_id(pending)
        logger.info(f"Тест найден: {test is not None}")
        if test:
            conn = get_db(); c = conn.cursor()
...
async def admin_panel(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if user_id != ADMIN_ID: await msg.reply_text("❌ У вас нет доступа!"); return
    await msg.reply_text("🔧 *АДМИН-ПАНЕЛЬ* ✨\n\nВыбери действие в меню 👇", parse_mode=ParseMode.MARKDOWN, reply_markup=get_admin_keyboard())
            ...
            try:
                await context.bot.send_message(
                    ...
                    text=f"🎁✨ *ПОДАРОК ДЛЯ ТЕБЯ!* ✨🎁\n\n"
                         ...
                         f"👯‍♀️ Узнай кто знает тебя лучше всех!\n\n"
                         f"💖 *Твори и делись!*",
                    parse_mode=ParseMode.MARKDOWN
                )
            except: pass
...
async def start_test(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if 'taking_test' in context.user_data:
        old_test = context.user_data['taking_test']['test']
        if old_test['id'] == tid:
            current = context.user_data['taking_test']['current']
            await query.message.reply_text(
                f"⏳ *Ты уже начала этот тест!*\n\nПродолжай с вопроса {current+1} из {len(old_test['questions'])} 💕",
                parse_mode=ParseMode.MARKDOWN
            )
            await asyncio.sleep(1.5)
            logger.info(f"Вызов send_question для продолжения теста")
            try:
                await send_question(query, context)
            except Exception as e:
                logger.error(f"Ошибка send_question: {e}")
                await query.message.reply_text("😢 Произошла ошибка. Начни тест заново /start")
            return
    
    conn = get_db(); c = conn.cursor(); c.execute('SELECT id FROM attempts WHERE test_id=? AND friend_id=?', (tid, user.id))
    if c.fetchone(): conn.close(); await query.message.reply_text("💔 *Ты уже прошла этот тест!*", parse_mode=ParseMode.MARKDOWN); return
...
async def send_question(query, context):
    ...
    logger.info(f"send_question: question={test['questions'][current][:50]}")
    kb = [[InlineKeyboardButton(opt[:40], callback_data=f"answer_{i}")] for i, opt in enumerate(test['options'][current])]
    # Определяем тест-пак
    
    # Ищем из какого тест-пака вопрос
    pack_name = ""
    for key, qs in QUESTIONS.items():
        if test['questions'][current] in qs:
            pack_name = QUESTION_GROUPS.get(key, key)
            logger.info(f"Найден тест-пак: {pack_name} для вопроса {test["questions"][current][:30]}")
            break
    
    qt = f"💭 *ВОПРОС {current+1} ИЗ {len(test["questions"])}*"
    if pack_name:
        qt += f"\n_из пакета {pack_name}_"
    qt += f"\n\n✨ {test["questions"][current]}\n\n_Выбери один вариант ответа:_ 🎯"

    await query.message.reply_text(qt, parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup(kb))
async def handle_answer(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    logger.info(f"Комментарий: current={current}, comment={comment}, comments_keys={list(comments.keys()) if comments else 'empty'}")
    if comment:
        result_text += f"\n\n💬 *Пояснение:*\n_{comment}_"
    
    await query.message.reply_text(result_text, parse_mode=ParseMode.MARKDOWN)
    
    # Отправляем голосовой комментарий если есть
    test = data['test']
    voice_comments = json.loads(test.get('voice_comments', '{}')) if test.get('voice_comments') else {}
    if str(current) in voice_comments:
        try:
            await query.message.reply_voice(voice_comments[str(current)], caption="🎤 *Пояснение от подруги:*", parse_mode=ParseMode.MARKDOWN)
        except:
            pass
...
async def finish_test(query, context):
    ...
    # Списываем тест у создателя (если не премиум)
    creator_id = test['creator_id']
    if not is_premium(creator_id):
        conn = get_db(); c = conn.cursor()
        c.execute('UPDATE users SET tests_created = tests_created + 1 WHERE user_id = ?', (creator_id,))
        conn.commit()
    status = get_friendship_status(score); prediction = get_friendship_prediction(score, test['creator_name'])
    try:
...
async def premium_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if is_premium(user_id):
        ...
        text = f"💎✨ *ДОБРО ПОЖАЛОВАТЬ В VIP!* ✨💎\n\n"
        text += f"👑 *Ты — королева!*\n\n"
        text += f"👁 Все ответы открыты\n"
        text += f"📊 Детальная статистика\n"
        text += f"🎓 Золотой диплом\n\n"
        text += f"📅 *Подписка до:* {expiry}\n\n"
        text += f"💕 _Смотри что ответили подруги и удивляйся!_ ✨"
        if hasattr(update, 'callback_query') and update.callback_query:
        ...
        text = "👁✨ *ОТВЕТЫ ПОДРУГ* ✨👁\n\n🌸 *Хочешь узнать что ответила каждая подруга?*\n\n👁 Смотри ответы на все вопросы\n📊 Сравнивай ответы подруг\n🔍 Узнай кто что выбрал\n\n💰 *Пакеты просмотров:*\n\n👁 1 ответ — 29₽\n👁 3 ответа — 59₽\n👁 10 ответов — 129₽\n\n💎 *Подписка:*\n\n🌸 1 день — 49₽\n⭐ 7 дней — 99₽\n💎 Навсегда — 399₽\n\n👇 Выбери:"
        if hasattr(update, 'callback_query') and update.callback_query:
...
async def buy_premium(update: Update, context: ContextTypes.DEFAULT_TYPE):
    query = update.callback_query
    if query.data == "buy_1view": days, price = 1, 29
    elif query.data == "buy_3views": days, price = 3, 59
    elif query.data == "buy_10views": days, price = 10, 129
    elif query.data == "buy_1day": days, price = 1, 49
    elif query.data == "buy_7days": days, price = 7, 99
    elif query.data == "buy_forever": days, price = 365, 399
    else: days, price = 7, 99
...
async def handle_buttons(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    elif text.startswith("🎁"): await daily_bonus_handler(update, context)
...
async def callback_handler(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    try:
        if data in ["buy_1view", "buy_3views", "buy_10views", "buy_1day", "buy_7days", "buy_forever"]:
    ...
    try:
        ...
        # === ГОТОВЫЕ НАБОРЫ ===
        elif data == "custom_test":
            await custom_test_handler(update, context)
        ...
        elif data.startswith("voice_comment_"):
            await voice_comment_start(update, context)
        ...
        # === ПОЛУЧИТЬ ДИПЛОМ ===
            ...
            if diploma_data:
                name = diploma_data.get('user_name', 'Подруга')
                creator = diploma_data.get('creator_name', 'Подругу')
                is_prem = is_premium(query.from_user.id)
                diploma_type = 'gold' if is_prem else 'gold'  # пока только gold
                webapp_url = f"https://fabregac123.github.io/Podrugatestbot/diploma/{diploma_type}.html?name={name}&creator={creator}&score={score}"
                await query.message.reply_text(
                    "🎓✨ *ТВОЙ ДИПЛОМ ГОТОВ!* ✨🎓",
                    parse_mode=ParseMode.MARKDOWN,
                    reply_markup=InlineKeyboardMarkup([
                        [InlineKeyboardButton("👑 Открыть диплом", web_app=WebAppInfo(url=webapp_url))]
                    ])
                )
            else:
        ...
        # === ПОДЕЛИТЬСЯ ===
            ...
            if is_premium(user_id):
                ...
                share_text = f"📤✨ *ПОДЕЛИСЬ ТЕСТОМ!* ✨📤\n\n💕 Отправь тест подруге и узнай насколько хорошо она тебя знает!\n\n🎯 Чем больше подруг пройдут — тем интереснее битва за звание лучшей! 👑\n\n🔮 *Зодиак-челлендж:* когда подруга пройдёт тест — её знак зодиака добавится в твою коллекцию!\n\n♾️ Тесты бесплатно! Отправляй без ограничений!\n\n👇 *Нажми на кнопку:*"
        ...
        # === УДАЛИТЬ ТЕСТ ===
            ...
            delete_test(query.from_user.id, tid)
            await query.answer("🗑 Тест удалён!")
...
async def select_question_group(update, context):
    ...
    data['total_q'] = min(10, len(data['group_questions']))  # По умолчанию 10 или сколько есть
    data['current_q'] = 0
    data['questions_data'] = []
    data['comments'] = {}
    data['photos'] = {}
    data["step"] = "greeting"
    await query.message.reply_text("🎬✨ *ДОБАВЬ ПОЗДРАВЛЕНИЕ!* ✨\n\nПодружка получит его после прохождения! 💕", parse_mode=ParseMode.MARKDOWN, reply_markup=InlineKeyboardMarkup([[InlineKeyboardButton("🎤 Голосовое", callback_data="greeting_voice"), InlineKeyboardButton("🎥 Видео", callback_data="greeting_video")], [InlineKeyboardButton("⏭️ Пропустить", callback_data="greeting_skip")]]))
    data["step"] = "greeting"
    # Берём все вопросы из пакета (до 10)
    data["total_q"] = min(10, len(data.get("group_questions", [])))
    data["current_q"] = 0
    data["questions_data"] = []
...
async def next_question_callback(update, context):
    ...
    # Определяем тест-пак — запоминаем ПЕРВЫЙ раз
    if 'current_pack' not in data:
        for key, qs_list in QUESTIONS.items():
            if qs[0] in qs_list:
                data['current_pack'] = QUESTION_GROUPS.get(key, key)
                break
    pack_name = data.get('current_pack', '')
    text = f"🌸 *ВОПРОС {data['current_q']+1} ИЗ {data['total_q']}*"
    if pack_name:
        text += f"\n_из пакета {pack_name}_"
    text += f"\n\n✨ {qs[idx]}"
...
async def random_question_callback(update, context):
    ...
    if not data: return
    random.seed(datetime.now().timestamp())
    # Исключаем уже показанные пакеты
    shown_packs = data.get('shown_packs', [])
    available_packs = [g for g in QUESTION_GROUPS if g not in shown_packs]
    if not available_packs:
        available_packs = list(QUESTION_GROUPS.keys())
        shown_packs = []
    
    random_pack = random.choice(available_packs)
    shown_packs.append(random_pack)
    data['shown_packs'] = shown_packs
    
    all_q = QUESTIONS.get(random_pack, []); random.shuffle(all_q)
    data['group_questions'] = all_q[:30]; data['current_question_index'] = 0; data['current_question'] = all_q[0]
    pack_name = QUESTION_GROUPS.get(random_pack, random_pack)
    text = f"🌸 *ВОПРОС {data['current_q']+1} ИЗ {data['total_q']}*"
    if pack_name:
        text += f"\n_из пакета {pack_name}_"
    text += f"\n\n✨ {all_q[0]}"
...
async def select_correct(update, context):
    ...
    await query.message.reply_text(
        ...
        "✏️ Напиши текстом *или*\n"
        "🎤 Запиши голосовое сообщение\n\n"
        "_Пример текста:_ «Да, я обожаю этот цвет!»\n"
        "_Голосовое:_ просто надиктуй пояснение 🎙",
        parse_mode=ParseMode.MARKDOWN,
        reply_markup=InlineKeyboardMarkup([
            [InlineKeyboardButton("🎤 Голосовой комментарий", callback_data=f"voice_comment_{ci}")],
            [InlineKeyboardButton("⏭️ Пропустить", callback_data=f"skip_comment_{ci}")]
        ])
    )
...
async def continue_after_comment(uoq, context, ci):
    data = context.user_data.get('creating_test')
    logger.info(f"continue_after_comment: current_q={data.get('current_q')}, total_q={data.get('total_q')}, questions_data_len={len(data.get('questions_data', []))}")
...
async def finish_test_creation(uoq, context):
    ...
    # Сохраняем голосовые комментарии
    voice_data = json.dumps(data.get('voice_comments', {})) if data.get('voice_comments') else None
    
    # Обновляем create_test чтобы принимать voice_comments
    # Пока сохраним в comments как JSON
    comments = data.get('comments', {})
    if data.get('voice_comments'):
        comments['_voice'] = data['voice_comments']
    
    tid = create_test(user.id, user.first_name, data['title'], qs, opts, corr, data.get('greeting_type'), data.get('greeting_file_id'), json.dumps(data.get("comments", {})), data.get('photos',{}))
...
async def show_friends_rating(update, context):
    user_id = update.effective_user.id
    logger.info(f"🏆 Рейтинг подруг запрошен: user_id={user_id}")
    conn = get_db()
    c = conn.cursor()
    ...
    if not ratings:
        await update.message.reply_text("🏆✨ РЕЙТИНГ ПОДРУГ ✨🏆\n\n🌸 У тебя пока нет подруг которые прошли твои тесты!\n\n💕 Создай тест и отправь подругам!\n👯‍♀️ Когда подруга пройдёт тест — ты увидишь её здесь!")
        return
    
    medals = ["🥇", "🥈", "🥉"]
    text = "🏆✨ <b>ТВОЙ ТОП ПОДРУГ</b> ✨🏆\n\n"
    for i, (name, friend_id, score, title) in enumerate(ratings):
        ...
        text += f"{icon} <b>{name}</b>{username_text}{zodiac_emoji} — <b>{score:.0f}%</b>\n   {hearts}\n   {level}\n   📝 {title}\n\n"
    text += f"👥 <b>Всего подруг:</b> {len(ratings)}\n💕 <b>Лучшая:</b> {ratings[0][0]}!"
...
async def handle_profile_setup(update, context):
    ...
    if step == "name":
        ...
        try:
            age = int(text)
            if age < 7 or age > 25:
                await update.message.reply_text("🌸 Укажи возраст от 7 до 25 лет!")
                return True
            profile["age"] = age
            profile["step"] = "zodiac"
            kb = []
...
async def handle_profile_zodiac(update, context):
    ...
    text = (f"🌸✨ *{profile['name']}, ТВОЙ ПРОФИЛЬ ГОТОВ!* ✨🌸\n\n"
            ...
            f"📊 Доступно: *{available} {word}*\n\n"
            f"💕 _Создай тест о себе и отправь подругам!_\n"
            f"👯‍♀️ _Узнай кто знает тебя лучше всех!_")
...
🎯 Что это за бот?
Создавай тесты о себе и отправляй подругам! Узнай кто знает тебя лучше всех!
...
async def daily_bonus_handler(update, context):
    """Ежедневный бонус с красивым дизайном"""
    user_id = update.effective_user.id
    today = datetime.now().strftime('%Y%m%d')
    ...
    if last_bonus == today:
        await update.message.reply_text(
            "🎁✨ *ТЫ УЖЕ ЗАБРАЛА БОНУС!* ✨🎁\n\n"
            "🌸 Заходи завтра за новым подарком!\n"
            "💕 _Не пропускай дни — награды становятся круче!_",
            parse_mode=ParseMode.MARKDOWN
        )
        return
    
    context.user_data['last_bonus'] = today
    streak = context.user_data.get('bonus_streak', 0) + 1
    context.user_data['bonus_streak'] = streak
    
    rewards = {
        1: ("+1 бесплатный просмотр", "👁"),
        2: ("+2 новые темы вопросов", "📝"),
        3: ("Скидка 10% на VIP", "💰"),
        4: ("+1 бесплатный просмотр", "👁"),
        5: ("Тест-пак «💘 Краш»", "💘"),
        6: ("+3 бесплатных просмотра", "👁"),
        7: ("💎 СКИДКА 50% НА VIP!", "💎"),
    }
    
    reward, icon = rewards.get(streak, ("+1 просмотр", "🎁"))
    
    # Прогресс-бар дней
    progress = "█" * streak + "░" * (7 - streak)
    
    text = f"{icon}✨ *ЕЖЕДНЕВНЫЙ БОНУС* ✨{icon}\n\n"
    text += f"📅 *День {streak} из 7*\n"
    text += f"[{progress}]\n\n"
    text += f"🎉 *Награда:* {reward}\n\n"
    
    if streak >= 7:
        text += "🔥 *МАКСИМАЛЬНЫЙ УРОВЕНЬ!*\n💎 Скидка 50% на VIP твоя!\n\n🌟 Завтра начни новый цикл!"
        context.user_data['bonus_streak'] = 0
    else:
        next_reward, next_icon = rewards.get(streak + 1, ("Сюрприз!", "🎁"))
        text += f"🌟 *Завтра:* {next_icon} {next_reward}\n"
        text += f"_Не пропусти — награды становятся круче!_"
    
    await update.message.reply_text(text, parse_mode=ParseMode.MARKDOWN)


async def custom_test_handler(update, context):
    """Создать свой тест без тест-пака"""
    query = update.callback_query
    try: await query.answer()
    except: pass
    data = context.user_data.get('creating_test')
    ...
    data['step'] = 'custom_questions'
    await query.message.reply_text("✏️ *Напиши свой первый вопрос:*\n\nОтправь вопрос текстом", parse_mode=ParseMode.MARKDOWN, reply_markup=get_cancel_keyboard())


async def voice_comment_start(update, context):
    """Начало записи голосового комментария"""
    query = update.callback_query
    try: await query.answer()
    except: pass
    ci = int(query.data.replace("voice_comment_", ""))
    data = context.user_data.get('creating_test')
    if not data: return
    data['waiting_voice_comment'] = True
    data['temp_correct_idx'] = ci
    await query.message.reply_text(
        "🎤 *Запиши голосовой комментарий*\n\n"
        "_Отправь голосовое сообщение с пояснением к вопросу_\n\n"
        "⏭️ Нажми «Пропустить» если не хочешь добавлять",
        parse_mode=ParseMode.MARKDOWN,
        reply_markup=InlineKeyboardMarkup([[
            InlineKeyboardButton("⏭️ Пропустить", callback_data=f"skip_comment_{ci}")
        ]])
...
async def save_voice_comment(update, context):
    """Сохранение голосового комментария"""
    if not update.message.voice: return
    
    # Сначала проверяем приветствие
    data = context.user_data.get('creating_test')
    if data and data.get('waiting_greeting'):
        await save_greeting(update, context)
        return
    
    if not data or not data.get('waiting_voice_comment'): return
    
    voice_file_id = update.message.voice.file_id
    ci = data['temp_correct_idx']
    
    if 'voice_comments' not in data:
        data['voice_comments'] = {}
    data['voice_comments'][str(data['current_q'])] = voice_file_id
    data['waiting_voice_comment'] = False
    
    await update.message.reply_text("✅ *Голосовой комментарий сохранён!* 🎤", parse_mode=ParseMode.MARKDOWN)
    await continue_after_comment(update, context, ci)


async def cleanup_voice_comments(context: ContextTypes.DEFAULT_TYPE):
    """Удаляет голосовые комментарии старше 3 дней"""
    try:
        conn = get_db()
        c = conn.cursor()
        # Находим тесты с голосовыми комментариями старше 3 дней
        c.execute("SELECT id, voice_comments FROM tests WHERE voice_comments IS NOT NULL AND voice_comments != '{}' AND created_at < datetime('now', '-3 days')")
        old_tests = c.fetchall()
        
        cleaned = 0
        for test in old_tests:
            c.execute("UPDATE tests SET voice_comments = NULL WHERE id = ?", (test['id'],))
            cleaned += 1
        ...
        if cleaned > 0:
            logger.info(f"🧹 Очищено голосовых комментариев: {cleaned} тестов")
    except Exception as e:
        logger.error(f"Ошибка очистки голосовых комментариев: {e}")
...
def main():
    ...
    # Очистка старых голосовых комментариев (старше 3 дней)
    job_queue.run_repeating(cleanup_voice_comments, interval=86400, first=300)
    ...
    app.add_handler(MessageHandler(filters.VOICE, save_voice_comment))
